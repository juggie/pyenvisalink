...
evl_Commands = {"KeepAlive": "00", "ChangeDefaultPartition": "01", "DumpZoneTimers": "02", "PartitionKeypress": "03"}
...
evl_ResponseTypes = {
    ...
    "%FF": {
        ...
        "description": "This command contains the raw zone timers used inside the Envisalink. The dump is a 256 character packed HEX string representing 64 UINT16 (little endian) zone timers. Zone timers count down from 0xFFFF (zone is open) to 0x0000 (zone is closed too long ago to remember). Each "
        "tick"
        " of the zone time is actually 5 seconds so a zone timer of 0xFFFE means "
        "5 seconds ago"
...
evl_TPI_Response_Codes = {
    ...
    "01": {"retry": True, "msg": "Receive Buffer Overrun (a command is received while another is still being processed)"},
    "02": {"retry": False, "msg": "Unknown Command"},
    "03": {"retry": False, "msg": "Syntax Error. Data appended to the command is incorrect in some fashion"},
    "04": {"retry": True, "msg": "Receive Buffer Overflow"},
    "05": {"retry": False, "msg": "Receive State Machine Timeout (command not completed within 3 seconds)"},
}
...
evl_CID_Qualifiers = {1: "New Event or Opening", 3: "New Restore or Closing", 6: "Previously Reported Condition Still Present"}
